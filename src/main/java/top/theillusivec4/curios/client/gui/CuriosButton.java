...
public class CuriosButton extends ImageButton {
  ...
  public static final WidgetSprites BIG =
      new WidgetSprites(ResourceLocation.fromNamespaceAndPath(CuriosApi.MODID, "button"), ResourceLocation.fromNamespaceAndPath(CuriosApi.MODID, "button_highlighted"));
  public static final WidgetSprites SMALL =
      new WidgetSprites(ResourceLocation.fromNamespaceAndPath(CuriosApi.MODID, "button_small"), ResourceLocation.fromNamespaceAndPath(CuriosApi.MODID, "button_small_highlighted"));
