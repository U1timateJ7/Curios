...
public interface ICurio {
   ...
   */
  @Nonnull
  default DropRule getDropRule(SlotContext slotContext, DamageSource source,
                               boolean recentlyHit) {
  ...
  default int getFortuneBonus(String identifier, LivingEntity livingEntity, ItemStack curio,
                              int index) {
    return EnchantmentHelper.getItemEnchantmentLevel(livingEntity.registryAccess().holderOrThrow(Enchantments.FORTUNE), curio);
  }
  ...
  default int getLootingBonus(String identifier, LivingEntity livingEntity, ItemStack curio,
                              int index) {
    return EnchantmentHelper.getItemEnchantmentLevel(livingEntity.registryAccess().holderOrThrow(Enchantments.LOOTING), curio);
  }
