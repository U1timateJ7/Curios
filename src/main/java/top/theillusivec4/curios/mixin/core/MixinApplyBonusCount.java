...
public class MixinApplyBonusCount {
  ...
  @ModifyVariable(at = @At(value = "INVOKE_ASSIGN", target = "Lnet/minecraft/world/item/enchantment/EnchantmentHelper;getItemEnchantmentLevel(Lnet/minecraft/core/Holder;Lnet/minecraft/world/item/ItemStack;)I"), method = "run")
  private int curios$applyFortune(int enchantmentLevel, ItemStack stack, LootContext lootContext) {
    if (this.enchantment.getKey() == Enchantments.FORTUNE) {
